...
# [CLS]+[SEP] --
python bert_run_train.py --run_id "roberta_large_cat4_add_tokens" --model_name "nlp-waseda/roberta-large-japanese-seq512" --model_custom_header "concatenate-4" --epochs 10
